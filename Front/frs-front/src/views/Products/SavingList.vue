      ...
      <table class="table table-striped">
        ...
        <tbody>
          <tr v-for="product in products" :key="product.id">
            <td>{{ product.id }}</td>
            <td><SavingOption6 :productId="product.id"/></td>
            <td><SavingOption12 :productId="product.id"/></td>
            <td><SavingOption24 :productId="product.id"/></td>
            <td><SavingOption36 :productId="product.id"/></td>
...
import SavingOption36 from '@/components/SavingOption36.vue'
